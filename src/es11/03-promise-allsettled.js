/* ES11: Promise.allSettled          clase 28/35


En alguna situación necesitarás manejar varias promesas y obtener sus resultados. ¿Cómo? Utilizando
 los métodos Promise.all y Promise.allSettled.

Promise.all

El método Promise.all sirve para manejar varias promesas al mismo tiempo. Recibe como 
argumento un array de promesas.
...
¿Debería usar Promise.allSettled en lugar de Promise.all? No, porque ambas son muy útiles 
dependiendo cómo quieras manejar tus promesas. */
...
//NOTA; resolve y reject se usan comunmente, pero no son palabras reservadas.Lo mismo seria con simon y nel ;)xd
/* Esto es lo que nos regresa:
[
    { status: 'rejected', reason: 'Reject, la promesa fallo' },
    { status: 'fulfilled', value: 'Resuelto, la promesa se resolvio' },
    {
      status: 'fulfilled',
      value: 'Resuelto2, la segunda promesa se resolvio'
    }
] 
  */