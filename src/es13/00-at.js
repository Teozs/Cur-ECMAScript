...
Los índices positivos comienzan desde 0 hasta la longitud total menos uno, de izquierda a 
derecha del array. El índice 0 es la primera posición.

[0,1,2,3, ...., lenght-1]
Los índices negativos comienzan desde -1 hasta el negativo de la longitud total del array, de 
derecha a izquierda. El índice -1 es la última posición.
...
console.log(array[array.length -1]);//asi es la forma en la que se hacia antes

console.log(array.at(-1));  //Esta es la nueva forma con at
